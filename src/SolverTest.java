...
public class SolverTest {
	...
	public void testTrayInput() {
	 Tray board;
            InputSource lines = new InputSource ("easy/easy");
            InputSource goalInput = new InputSource("easy/easy.goal");
            ...
            assertEquals(goal.toString(), "Position is (1,1). Height is 1 and Width is 1.");
